...
RDPO_region_quake_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPO_region_quake.shp'))
RDPO_region_winter_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPO_region_winter.shp'))
RDPO_Lsd_Clark_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPO_Lsd_Clark.shp'))
RDPO_counties_quake_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPO_counties_quake.shp'))
RDPOflood_OR_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPOflood_OR.shp'))
RDPO_counties_volcano_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPO_counties_volcano.shp'))
RDPO_Lsld_OR_tif = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/reprojected/RDPO_Lsld_OR.tif'))
RDPOFire_Clark_tif = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/reprojected/RDPOFire_Clark.tif'))
RDPO_region_summer_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPO_region_summer.shp'))
RDPO_region_fire_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPO_region_fire.shp'))
RDPOCascadiaM9_3_Clark_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPOCascadiaM9_3_Clark.shp'))
RDPOFire_OR_tif = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/reprojected/RDPOFire_OR.tif'))
RDPO_region_volcano_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPO_region_volcano.shp'))
RDPOLiquefaction_OR_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPOLiquefaction_OR.shp'))
RDPOCascadiaM9_Col_tif = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/reprojected/RDPOCascadiaM9_Col.tif'))
RDPOflood_clark_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPOflood_clark.shp'))
RDPO_region_flood_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPO_region_flood.shp'))
RDPOvolcanoes_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPOvolcanoes.shp'))
RDPO_counties_winter_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPO_counties_winter.shp'))
RDPO_counties_fire_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPO_counties_fire.shp'))
RDPO_WA_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPO_WA.shp'))
RDPO_counties_flood_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPO_counties_flood.shp'))
RDPO_OR_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPO_OR.shp'))
RDPOCascadiaM9_3Cnty_tif = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/reprojected/RDPOCascadiaM9_3Cnty.tif'))
RDPO_region_slide_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPO_region_slide.shp'))
RDPOCascadiaM9_OR_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPOCascadiaM9_OR.shp'))
RDPOLiquefact_Clark_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPOLiquefact_Clark.shp'))
RDPO_counties_summer_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPO_counties_summer.shp'))
RDPOhistflood_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPOhistflood.shp'))
RDPO_counties_slide_shp = os.path.abspath(os.path.join(os.path.dirname(BASE_DIR), 'disasterinfosite/data/simplified/RDPO_counties_slide.shp'))
...
# loadImports
    ...
    from disasterinfosite.models import RDPO_region_quake
    ...
    from disasterinfosite.models import RDPO_region_winter
    ...
    from disasterinfosite.models import RDPO_Lsd_Clark
    ...
    from disasterinfosite.models import RDPO_counties_quake
    ...
    from disasterinfosite.models import RDPOflood_OR
    ...
    from disasterinfosite.models import RDPO_counties_volcano
    ...
    from disasterinfosite.models import RDPO_region_fire
    ...
    from disasterinfosite.models import RDPOCascadiaM9_3_Clark
    ...
    from disasterinfosite.models import RDPOFire_OR
    tileLoadRaster(RDPOFire_OR, RDPOFire_OR_tif)

    print('Loading data for RDPO_region_volcano')
    from disasterinfosite.models import RDPO_region_volcano
    ...
    from disasterinfosite.models import RDPOLiquefaction_OR
    ...
    from disasterinfosite.models import RDPOCascadiaM9_Col
    tileLoadRaster(RDPOCascadiaM9_Col, RDPOCascadiaM9_Col_tif)

    print('Loading data for RDPOflood_clark')
    from disasterinfosite.models import RDPOflood_clark
    ...
    from disasterinfosite.models import RDPO_region_flood
    ...
    from disasterinfosite.models import RDPOvolcanoes
    ...
    from disasterinfosite.models import RDPO_counties_winter
    ...
    from disasterinfosite.models import RDPO_counties_fire
    ...
    from disasterinfosite.models import RDPO_WA
    ...
    from disasterinfosite.models import RDPO_counties_flood
    ...
    from disasterinfosite.models import RDPO_OR
    ...
    from disasterinfosite.models import RDPOCascadiaM9_3Cnty
    tileLoadRaster(RDPOCascadiaM9_3Cnty, RDPOCascadiaM9_3Cnty_tif)

    print('Loading data for RDPO_region_slide')
    from disasterinfosite.models import RDPO_region_slide
    ...
    from disasterinfosite.models import RDPOCascadiaM9_OR
    ...
    from disasterinfosite.models import RDPOLiquefact_Clark
    ...
    from disasterinfosite.models import RDPO_counties_summer
    ...
    from disasterinfosite.models import RDPOhistflood
    ...
    from disasterinfosite.models import RDPO_counties_slide
